 ...
 * ```
 */
export declare class FirebaseAuthenticationOriginal extends IonicNativePlugin {
    /**
...
export declare const FirebaseAuthentication: FirebaseAuthenticationOriginal;