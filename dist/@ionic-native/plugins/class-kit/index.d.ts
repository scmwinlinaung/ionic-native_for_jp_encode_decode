...
export declare enum CCKContextType {
    none = 0,
    app = 1,
    chapter = 2,
    section = 3,
...
export declare enum CCKContextTopic {
    math = "math",
    science = "science",
...
export declare enum CCKBinaryType {
    trueFalse = 0,
    passFail = 1,
    yesNo = 2
}
 ...
 * CCKQuantityItem
 */
export declare class ClassKitOriginal extends IonicNativePlugin {
    /**
     * Init contexts defined in XML file 'CCK-contexts.xml'
...
export declare const ClassKit: ClassKitOriginal;