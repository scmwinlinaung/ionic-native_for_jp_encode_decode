 ...
 * MixpanelPeople
 */
export declare class MixpanelOriginal extends IonicNativePlugin {
    /**
 ...
 * @hidden
 */
export declare class MixpanelPeopleOriginal extends IonicNativePlugin {
    /**
     *
...
export declare const Mixpanel: MixpanelOriginal;
export declare const MixpanelPeople: MixpanelPeopleOriginal;