 ...
 */
export declare enum AuthenticateAndActivateResultType {
    /**
...
export declare enum AuthenticateLocalResultType {
    /**
...
export declare enum LoginListenerType {
    /**
...
export declare enum NotificationListenerType {
    /**
...
export declare enum AttachmentItemStatus {
    DEFAULT = 0,
...
export declare class UnviredResult {
    /**
...
export declare class LogResult extends UnviredResult {
    type: ResultType;
    data: LogLevel;
}
export declare class LogDataResult extends UnviredResult {
    type: ResultType;
    data: string;
}
export declare class NotifResult extends UnviredResult {
    type: NotificationListenerType;
}
export declare class SettingsResult extends UnviredResult {
    data: Settings;
    type: ResultType;
}
export declare class SyncResult extends UnviredResult {
    type: ResultType;
}
export declare class DbResult extends UnviredResult {
    type: ResultType;
}
...
export declare class LoginResult extends UnviredResult {
    type: LoginListenerType;
}
export declare class AuthenticateActivateResult extends UnviredResult {
    type: AuthenticateAndActivateResultType;
}
export declare class AuthenticateLocalResult extends UnviredResult {
 ...
 */
export declare class UnviredCordovaSDKOriginal extends IonicNativePlugin {
...
export declare const UnviredCordovaSDK: UnviredCordovaSDKOriginal;