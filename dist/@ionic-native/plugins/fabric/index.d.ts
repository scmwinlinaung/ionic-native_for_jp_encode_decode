 ...
 * ```
 */
export declare class CrashlyticsOriginal extends IonicNativePlugin {
    /**
 ...
 * ```
 */
export declare class AnswersOriginal extends IonicNativePlugin {
    /**
...
export declare const Crashlytics: CrashlyticsOriginal;
export declare const Answers: AnswersOriginal;