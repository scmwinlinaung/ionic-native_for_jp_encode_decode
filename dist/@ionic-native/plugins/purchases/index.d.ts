 ...
 * RCError
 */
export declare class PurchasesOriginal extends IonicNativePlugin {
    /**
    ...
    addAttributionData(data: {
        [key: string]: any;
    }, network: ATTRIBUTION_NETWORKS): void;
    /**
     ...
     */
    getProducts(productIdentifiers: string[], type?: ProductType): Observable<[RCProduct]>;
    /**
     * Make a purchase
     ...
     */
    makePurchase(productIdentifier: string, oldSku?: string, type?: ProductType): Observable<RCMakePurchaseResponse>;
    /**
...
export declare const Purchases: PurchasesOriginal;