 ...
 * ```
 */
export declare class SignInWithAppleOriginal extends IonicNativePlugin {
    /**
     ...
     */
    signin(arg0?: object): Promise<AppleSignInResponse>;
}

export declare const SignInWithApple: SignInWithAppleOriginal;