 ...
 * ```
 */
export declare class ExtendedDeviceInformationOriginal extends IonicNativePlugin {
    /**
...
export declare const ExtendedDeviceInformation: ExtendedDeviceInformationOriginal;