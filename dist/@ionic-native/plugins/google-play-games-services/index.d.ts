 ...
 * ```
 */
export declare class GooglePlayGamesServicesOriginal extends IonicNativePlugin {
    /**
...
export declare const GooglePlayGamesServices: GooglePlayGamesServicesOriginal;