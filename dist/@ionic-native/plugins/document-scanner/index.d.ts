...
export declare enum DocumentScannerSourceType {
    /**
 ...
 */
export declare class DocumentScannerOriginal extends IonicNativePlugin {
    /**
     * Scan a document
...
export declare const DocumentScanner: DocumentScannerOriginal;